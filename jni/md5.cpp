...
void MD5::update(FILE * file) {
	...
	do {
		length = fread(buffer, BUFFER_SIZE, 1, file);
		//fflush(file);
		//ALOGD("update length = %d\n", length);
		if (length > 0)
...
void MD5::bytesToHexString(const byte *input, size_t length, char * md5) {
