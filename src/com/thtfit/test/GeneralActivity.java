...
public class GeneralActivity extends Activity { //implements OnClickListener {
	...
	private static String MEMORY_TEST = "Memory test result";
	private static String FLASH_TEST = "Flash test result";
	private static String SDCARD_TEST = "Sdcard test result";
	private static String U_DISC_TEST = "U disc test result";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try{
            MEMORY_TEST= this.getResources().getString(R.string.memory_test_result);
            FLASH_TEST = this.getResources().getString(R.string.flash_test_result);
            SDCARD_TEST = this.getResources().getString(R.string.sdcard_test_result);
			U_DISC_TEST = this.getResources().getString(R.string.u_disc_test_result);
		...
		mHandle = new Handler() {
			public void handleMessage(Message msg) {
				...
				if(msg.what == Block.StopMessage){
					mText1.setText( MEMORY_TEST);
					mText1.setTextColor(defaultColor);
					mText2.setText(FLASH_TEST);
					mText2.setTextColor(defaultColor);
					mText3.setText(SDCARD_TEST);
					mText3.setTextColor(defaultColor);
					mText4.setText(U_DISC_TEST);
